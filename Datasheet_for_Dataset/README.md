...
2. **How many instances are there in total (of each type, if appropriate)?**
    ...
    In total, there are **16148** instances in this dataset from **6** different object categories. All the instances are captured from **2** camera views. The overall dataset statistics below reflect the above description:
